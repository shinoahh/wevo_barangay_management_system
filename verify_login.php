...
if (isset($_POST["submit"])) {
    ...
    error_log('Submitted Username/Email: ' . $usernameAndEmail);
    ...
    $stmt = $conn->prepare("SELECT * FROM account WHERE email = ? OR username = ?");
    $stmt->bind_param("ss", $usernameAndEmail, $usernameAndEmail);
    $stmt->execute();
